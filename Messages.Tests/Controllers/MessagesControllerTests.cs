...
namespace MessagesTests.Controllers
{
    public partial class MessagesControllerTests
    {
        ...
        private readonly WriteMessageViewModel _palindromeMessage = new WriteMessageViewModel
        {
            Message = "Live on time, emit no evil"
        };

        private readonly WriteMessageViewModel _nonPalindromeMessage = new WriteMessageViewModel
        {
